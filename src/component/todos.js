...
//Add deleteTodo as a new property to the Todos component
      ...
      return (
        <Grid key={todo.id}>
          <Card style={{ marginTop: 10 }}>
            ...
            Will change this from CardContent to List such as ListItemButton, ListItemText*/}
            <ListItemButton component="a" href="#simple-list">
              {/*Check box use to mark the done item and delete when it done 
              by using deleteTodo function and pass in todo.id */}
              <Checkbox
                style={{ paddingLeft: 0 }}
                color="primary"
